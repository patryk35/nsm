...
public class UsedSwapSpaceSizeWorker extends MonitoringWorker {
    private OperatingSystemMXBean bean;

    public UsedSwapSpaceSizeWorker(ConnectionWorker connectionWorker, UUID serviceId, MonitoredParameterConfiguration monitoredParameterConfiguration) {

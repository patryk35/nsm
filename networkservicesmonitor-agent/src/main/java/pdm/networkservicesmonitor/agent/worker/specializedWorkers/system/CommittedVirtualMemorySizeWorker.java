...
@Slf4j
public class CommittedVirtualMemorySizeWorker extends MonitoringWorker {
    private OperatingSystemMXBean bean;

    public CommittedVirtualMemorySizeWorker(ConnectionWorker connectionWorker, UUID serviceId, MonitoredParameterConfiguration monitoredParameterConfiguration) {

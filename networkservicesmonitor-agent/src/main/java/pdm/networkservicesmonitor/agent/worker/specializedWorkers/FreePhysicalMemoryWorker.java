...
@Slf4j
public class FreePhysicalMemoryWorker extends SystemMonitoringWorker {


    public FreePhysicalMemoryWorker(ConnectionWorker connectionWorker, UUID serviceId, MonitoredParameterConfiguration monitoredParameterConfiguration) {
    ...
    String getMonitoredValue() {
        return String.valueOf(bean.getFreePhysicalMemorySize());
    }

...
public class AgentCPUUsageWorker extends MonitoringWorker {
    private OperatingSystemMXBean bean;

    public AgentCPUUsageWorker(ConnectionWorker connectionWorker, UUID serviceId, MonitoredParameterConfiguration monitoredParameterConfiguration) {
